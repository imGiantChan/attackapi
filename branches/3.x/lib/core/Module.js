...
/**
 * @cat Core
 * @name AttackAPI.Module
 * @desc AttackAPI module
 */
AttackAPI.Module = function () {};

/**
 * @cat Core
 * @name AttackAPI.Module.prototype.initialize
 * @desc module constructor prototype
 */
AttackAPI.Module.prototype.initialize = function () {};

/**
 * @cat Core
 * @name AttackAPI.Module.extend
 ...
 */
AttackAPI.Module.extend = function (def) {
	var classDef = function() {
		if (arguments[0] !== AttackAPI.Module) {
			this.initialize.apply(this, arguments);
		}
	};
	
	var proto = new this(AttackAPI.Module);
 ...
 * optional.
 */
AttackAPI.Module.implement = function (def, map) {
